...
class GameEnd extends React.Component{
    render() {
        ...
        return (
            <div>
                <h2>Life has reached stasis in {generations} generations</h2>
            </div>
        );
    }
}
        ...
        return (
            <div className="center">
                <ButtonToolbar>
                    ...
                    <Button className="btn btn-default" onClick={this.props.resetSpeed}>
                        Reset Speed
                    </Button>
...
class Main extends React.Component {
    ...
    render() {
        ...
        let gameEnd = gameOver ? <GameEnd generations={this.state.generation}/> : "";
        ...
        return (
            <div>
                ...
                />
                <h2>MS Between Updates: {this.speed} Generations: {this.state.generation}</h2>
                {gameEnd}
            </div>
        );
    }
